import { c as createLucideIcon, o, r as reactExports, v as vt, u as usePlayer, a as useNavigate, j as jsxRuntimeExports, H as Heart, S as Skeleton, B as Button } from "./index-DSY_0Yw_.js";
import { e as useFavorites, g as useRemoveFavorite, u as useChannels, m as motion } from "./proxy-BHY4Xx0o.js";
/**
...
function FavoritesPage() {
  ...
  function handleRemove(e, track) {
    e.stopPropagation();
    removeFav.mutate(track.id);
    dispatch({ type: "REMOVE_FAVORITE", trackId: track.id });
    ue.success(`Removed "${track.title}" from favorites`);
  }
  function handlePlay(track) {
    ...
    if (channel) {
      ...
      ue.error("Channel not found");
    }
  }
  const getChannelName = (channelId) => {
    var _a;
    return ((_a = channels.find((c) => c.id === channelId)) == null ? void 0 : _a.name) ?? "Unknown Channel";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-card border-b border-border overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative px-6 py-10 max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full gradient-tropical flex items-center justify-center shadow-md flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Heart,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground tracking-tight leading-tight", children: "Favorites" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mt-1 flex items-center gap-1.5 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Waves, { className: "size-3.5 text-secondary", "aria-hidden": "true" }),
                favorites.length > 0 ? `${favorites.length} track${favorites.length !== 1 ? "s" : ""} saved` : "Your saved tracks"
              ] })
            ] })
          ]
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 pb-12", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "favorites.loading_state", children: SKELETON_IDS.map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[72px] rounded-xl" }, id)) }) : favorites.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: favorites.map((track, i) => {
          var _a;
          const isActive = ((_a = state.currentTrack) == null ? void 0 : _a.id) === track.id;
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.button,
            {
              ...
              className: [
                ...
                isActive ? "bg-primary/10 border-primary/30" : "bg-card/50 border-transparent hover:bg-accent/10 hover:border-accent/25"
              ].join(" "),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-12 h-12 rounded-lg overflow-hidden flex-shrink-0 border border-border/50 shadow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                  ...
                  isNowPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex gap-[3px] items-end h-4", children: ["b1", "b2", "b3"].map((bId, bi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-sm font-semibold truncate leading-snug ${isActive ? "text-primary font-display" : "text-foreground"}`,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary/80", children: channelName })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono tabular-nums hidden sm:block flex-shrink-0", children: formatTime(track.duration) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "button",
...
function EmptyState() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8 w-24 h-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full gradient-tropical opacity-20 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 rounded-full bg-card border border-border flex items-center justify-center shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl select-none", role: "img", "aria-label": "sunset", children: "🌅" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-3", children: "No tracks saved yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mb-8 max-w-xs leading-relaxed", children: [
          "Explore the channels and hit the",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "inline size-3.5 text-accent fill-current mx-0.5 align-middle" }),
          " ",
          "heart to save your favorite tracks here."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8 text-muted-foreground/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Waves, { className: "size-5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono tracking-widest uppercase", children: "Explore channels" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Waves, { className: "size-5 scale-x-[-1]" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
